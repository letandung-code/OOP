...
public class Main {
	...
	static void dulieuMau() {
		ql.Them(new HangThucPham("TP001", "Sữa tươi Vinamilk", LocalDate.of(2026, 1, 15), LocalDate.of(2026, 2, 15), 25000f));
		ql.Them(new HangThucPham("TP002", "Bánh quy Oreo", LocalDate.of(2026, 3, 5), LocalDate.of(2026, 6, 5), 15000f));
		ql.Them(new HangThucPham("TP003", "Nước ngọt Coca", LocalDate.of(2026, 1, 20), LocalDate.of(2026, 9, 20), 12000f));
		ql.Them(new HangThucPham("TP004", "Sữa chua TH True", LocalDate.of(2026, 5, 10), LocalDate.of(2026, 5, 25), 8000f));
		ql.Them(new HangThucPham("TP005", "Bánh mì Kinh Đô", LocalDate.of(2026, 8, 1), LocalDate.of(2026, 8, 15), 20000f));
	...
	static void xoaThucPham() {
		try {
			...
			if (ql.xoaTheoID(id)) System.out.println("✔ Đã xóa id " + id);
		} catch (NumberFormatException e) {
	...
	static void suaThucPham() {
		try {
			...
			if (ql.suaTheoID(id, ten, sx, hh, gia)) System.out.println("✔ Đã sửa id " + id);
		} catch (Exception e) {
			System.out.println("x Lỗi: " + e.getMessage());
		}
	}
	...
	static void trichlocTheoNgay() {
		try {
			...
			else { System.out.println("⚠ Không hợp lệ!"); return; }
